CC := gcc
CFLAGS := -g -I include --include /usr/include/HOL/HOL_standard.h
LIB := -lglfw -lglad -lm -lyyjson
...
OBJ:= build/context.o build/opengl_context.o build/file.o build/opengl_engine.o build/glfw_callback.o\
      ...
      build/shader.o build/model_3d.o build/vulkan_context.o build/mouse_event.o build/window_event.o
